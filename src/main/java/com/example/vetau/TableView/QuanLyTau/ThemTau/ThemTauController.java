...
public class ThemTauController implements Initializable {
    ...
    public void Start()
    {
        chitietTau_add = QuanLyTauController.getChitietTau();
    ...
    public void LoadData_tau()
    {
        ...
        Soluongghe_add_coll.setCellFactory(createTextFieldCellFactory_Loai_toa());
    ...
    private Callback<TableColumn<ChitietTau, String>, TableCell<ChitietTau, String>> createTextFieldCellFactory_Loai_toa() {
                ...
                if (empty) {
                    ...
                    textField.focusedProperty().addListener((observable, oldValue, newValue) -> {
                        if (!newValue) {
                            ...
                            rowItem.setLoaitoa(textField.getText());
                        }
                    });
